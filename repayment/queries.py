class Query:
    ...
    def report_top():
        ...
        SELECT 
            ...
            T.PERIOD_2,
            SUM(DECODE(T.CODE_VAL, 
                '840', T.PROGNOZ_POGASH*10173.28, 
                '978', T.PROGNOZ_POGASH*11411.48, 
                '392', T.PROGNOZ_POGASH*94.89,
                T.PROGNOZ_POGASH)) TOTAL,
            SUM(DECODE(T.CODE_VAL, '000', T.PROGNOZ_POGASH, 0)) NATIONAL
        FROM (
            SELECT 
                UNIQUE_CODE,
                MFO,
